    ...
    render() {
        return [
            ...
            <div key="body" className="llu-body_form">
                ...
                <hr style={{width: '60%', marginTop: 0, marginBottom: 0}}/>
                {/*Seleccion*/}
                <label htmlFor="basic-url" style={{marginBottom: '10px'}}>Tu hostal es perfecto si el viajero
                    busca...</label>
                <div className="input-group container">
                    <ul style={{width: '100%'}}>
                        <LluIconSelect from='hostel' className="pointer fas fa-shield-alt">Barrio
                            Histórico</LluIconSelect>
                        <LluIconSelect from='hostel' className="pointer fab fa-pagelines">Naturaleza</LluIconSelect>
                    ...
                    <ul style={{width: '100%'}}>
                        <LluIconSelect from='hostel' className="pointer fas fa-users">Ambiente Familiar</LluIconSelect>
                        <LluIconSelect from='hostel' className="pointer fas fa-thumbs-up">Comunidad
                            Social</LluIconSelect>
                        <LluIconSelect from='hostel' className="pointer fas fa-smile">Fiestas</LluIconSelect>
                        <LluIconSelect from='hostel' className="pointer fas fa-bicycle">Deporte Aventura</LluIconSelect>
                    </ul>
                    <ul style={{width: '100%'}}>
                        <div>
                            <span>Otros</span>
                ...
                <div className="shadow" style={{
                    ...
                    <div className="input-group container">
                        ...
                        <input placeholder="Calle Valparaiso 618, Viña del Mar" type="text" className="llu-input_form"/>
                        <div className="input-group-append">

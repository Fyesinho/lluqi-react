...
import LluFormStep4 from "../../../LluComponents/LluCommon/LluFormHostalStep4/LluFormHostalStep4";

class LluModalRegisterStep4 extends LluComponent {
    render() {
        return (
                ...
                <div className="row" style={{marginLeft: 0, marginRight: 0}}>
                    <div className="col-6">
                        <div className="llu-gradient">
                            <LluFormStep4 closeModal={this.props.closeModal}/>
                        </div>
                    </div>
                    <div className="col-6">
...
export default LluModalRegisterStep4;